...
<script
	src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=aii1pydhrn&submodules=geocoder"></script>
		...
		<form action="/join" method="post" id="form">
			<table class="table">
				<tr class="tr">
					...
					<td><input type="text" id="id" name="memberId" class="t-con" required><span
				...
				<tr class="tr">
					...
					<td><input type="text" id="name" name="memberName"
						class="t-con" required><span class="comment"></span></td>
				...
				<tr class="tr">
					...
					<td><input type="password" id="rePw" name="rePw" class="t-con"
						required><span class="comment"></span></td>

				</tr>
				<tr class="tr">
					<td class="title">휴대폰번호</td>
					<td><input type="text" id="phone" name="phone" class="t-con"
						placeholder="예시 000-0000-0000" required><span
						class="comment"></span></td>
				...
				<tr class="tr">
					...
					<td><input type="text" id="address" name="address"
						class="t-con" readonly> <input type="button" value="주소검색"
						id="addrSearchBtn" onclick="addrSearch();" required> <span
						class="comment"></span></td>
				...
				<tr class="tr">
					<td class="title">성별
					<td colspan="1"></</td>
					<input type="radio" id="m" name="gender" class="t-con2" value="남">남
					<input type="radio" id="f" name="gender" class="t-con2" value="여">여
					</td>
					<td><span class="comment"></span></td>
				</tr>
				<tr class="tr">
					<td class="title">나이</td>
					<td><input type="text" id="age" name="age" class="t-con"
						required><span class="comment"></span></td>
	...
	$(function() {
		...
		$('#id').focusout(function() {
			...
			if (!idReg.test($(this).val())) {
				comments[0].innerHTML = "영문 소문자 및 숫자 5~12자리 영어로 시작해 주세요";
				var memberId = $("#id").val();
		...
		$('#rePw').focusin(function() {
			if ($("#pw").val() == "") {
				comments[2].innerHTML = "비밀번호가 입력 되지 않았습니다.";
				$("#pw").focus();
			}
		});
		...
		$('#phone').focusout(function() {
			...
			if (!phoneReg.test($(this).val())) {
				comments[4].innerHTML = "010-xxxx-xxxx로 입력해주세요";
				count[4] = false;
			} else {
