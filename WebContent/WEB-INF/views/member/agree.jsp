...
<body>
	...
	<img src="../../../imgs/backImg1.jpg" id="img1">
		<div class="content">
            <h1>약관동의</h1>
            <form action="/joinFrm" method="post" id="form">
                <h1>[필수]이용약관 동의</h1>
                <textarea style="resize:none;" rows="10" cols="140" readonly >
                                                                                                                                                              제 1 장 총칙
                                                                                                                                                              
                                                                                                                                                              
제 1 조 (목적)
1. 본 약관은 머리좀헤어 사이트가 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 기업마당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (약관의 효력과 변경)
1. 머리좀헤어 사이트는 귀하가 본 약관 내용에 동의하는 경우 기업마당 사이트의 서비스 제공 행위 및 귀하의 서비스 사용 행위에 본 약관이 우선적으로 적용됩니다.
2. 머리좀헤어 사이트는 본 약관을 사전 고지 없이 변경할 수 있고 변경된 약관은 기업마당 사이트 내에 공지하거나 e-mail을 통해 회원에게 공지하며, 공지와 동시에 그 효력이 발생됩니다.
...
1. 기업마당 사이트와 이용자 간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, 본 분쟁으로 인한 소는 대한민국의 법원에 제기합니다.
                ...
                <div><input type="checkbox" id="chk1" required><span>동의함</span></div>
                <h1>[필수]개인정보 처리방침 동의</h1>
                <textarea style="resize:none;" rows="10" cols="140" readonly >
                																     개인정보 처리방침 동의
                									
머리좀헤어는 「개인정보보호법」 제15조제1항제1호, 제17조제1항제1호, 제23조제1호, 제24조제1항 제1호에 따라
아래와 같이 개인정보의 수집. 이용에 관하여 귀하의 동의를 얻고자 합니다.

머리좀헤어는 이용자의 사전 동의 없이는 이용자의 개인정보를 함부로 공개하지 않으며, 수집된 정보는 아래와 같이 이용하고 있습니다.
...
정보주체는 개인정보 수집에 동의를 거부할 권리가 있습니다. 다만, 필수 항목에 대한 동의를 거부할 시 저희가 제공하는 서비스를 이용할 수 없습니다.
                ...
                <div><input type="checkbox" id="chk2"required><span>동의함</span></div>
                <h1>[선택]마케팅 활용 동의</h1>
                 <textarea style="resize:none;" rows="10" cols="140" readonly >
                																마케팅/홍보의 수집의 이용 동의
...
개인정보의 마케팅/홍보의 수집 및 이용 동의를 거부하시더라도 회원 가입 시 제한은 없습니다. 다만, 마케팅 활용 서비스 안내 및 참여에 제한이 있을 수 있습니다.
                ...
                <div><input type="checkbox" id="chk3"><span>동의함</span></div>
                <div id="bottomBtn">
	                <button type="submit" id="nextBtn" value="다음단계">다음단계</button>
