...
<body>
	<div class="wrapper">
        ...
        브랜드로 세계적인 명성을 얻어 가고 있습니다.</pre>
			...
			<div>
				...
				<div class="content1">
					<span class="spanTitle">프리미엄 뷰티 서비스를 어느 살롱에서나</span>
					<pre>
            MEORIJOM HAIR는 직영 시스템에 준하여 살롱을 운영하고 있습니다.
            MEORIJOM HAIR만의 뷰티 서비스 퀄리티를 유지하는 비결입니다.
            어느 살롱에서나 MEORIJOM HAIR만의 탁월한 서비스를 경험하실 수 있습니다.</pre>
				</div>
				<div class="div2">
					<div class="img1">
						<div>4Salons</div>
    ...
    한국의 미용을 배우고자 MEORIJOM HAIR를 찾는 해외 미용사들이 
       많이 급증하는 추세입니다.</pre>
			...
			<div>
				...
				<br>
				<div class="content1">
					<span class="spanTitle">헤어&뷰티 업계의 기준점 MEORIJOM HAIR</span>
					<pre>
        언제나 새로운 스타일을 연구/제한하고,가장 트렌디한 이미지를 제시합니다. 
            체계적으로 프리미엄 뷰티 서비스를 제공하는 MEORLJOM HAIR다움으로 한국산업의 브랜드파워 3년 연속 1위~!</pre>
				</div>
				<div class="div2">
					<div class="img3">
						<div class="ranking1">
						...
						<div>
							2016년<br> 한국산업의 브랜드파워<br> 헤어&뷰티브랜드샵 부분
						</div>
					...
					<div class="img4">
						...
						<div>
							...
							2018년(2016~2018)<br> 한국산업의 브랜드파워<br> 헤어&뷰티브랜드샵 부분
        ...
        2007~2013년 트렌드 비전 어워드 코리아 1위 7회 연속 수상</pre>
			</div>
			...
			<div>
				...
				<div class="content1">
					<span class="spanTitle">트렌드를 선도하는 MEORIJOM HAIR의 창의성
						Creativity</span>
					<pre>
        ...
        전반적인 패션,뷰티를 아우르는 앞선 트렌드를 선보이며 큰 호응을 얻고 있습니다.</pre>
			...
			<div class="content1">
				<span class="spanTitle">상상을 초월하는 로열티의 열정적인 MEORIJOM HAIR Man</span>
				<pre>
        MEORIJOM HAIR의 아낌 없는 직원 교육과 적절한 보상제도
        MEORIJOM HAIR의 평균 이직률 10%
        <span class="spanTitle2">10</span><small>년 이상 근속 직원은</small> <span
						class="spanTitle2">250명</span><small>을 넘어서고 있습니다.</small>
				</pre>
			</div>
    ...
    고객님의 마음에 세 걸음 다가가 고객 감동을 이어갑니다.</pre>
			</div>
        ...
        MEORIJOM HAIR 3 Step만이 유일한 서비스 매뉴얼입니다.</pre>
			</div>
		</div>
